...
parser.add_argument('-c', '--data-config', type=str, default='data/emj.yaml',
    ...
    if training_mode:
        ...
        for epoch in range(args.num_epochs):
            ...
            train(model, loss_func, opt, scheduler, train_loader, dev, epoch,
                  steps_per_epoch=args.steps_per_epoch, grad_scaler=grad_scaler, tb_helper=tb, m_file=m_file)
